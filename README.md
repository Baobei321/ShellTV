...
ℹ️ 由于条件有限，本项目的开发测试主要基于机顶盒和[有限的几个源](source.md)，可能无法满足所有源的兼容性，请谅解。如果你发现闪退等bug可以QQ我，并注明你所使用的设备和源，我将尽力修改。
...
4.在**电视壳子**主页，点击直播，即可看到[直播节目](./images/broadcast.png)。（⚠️ 注意选择正确的播放器，通常是IJK，你也可能在配置文件中指定）
