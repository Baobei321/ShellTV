...
- 与原开源项目（TvBox）相比，本项目在功能上没有太多改进，主要是依个人喜好对操作体验进行了一些优化：
    ...
    - 直播节目收藏等其它一些功能
- 联系我们:  QQ 3877275490 [邮件](mailto:3877275490@qq.com)

--- 

## 🛠️ 对源配置文件语法的补充定义
为改进用户体验，**电视壳子**对TvBox项目的[源配置文件的语法定义](./tvbox源配置文件基本语法.md)进行了扩展，如果你是进阶玩家（致力于定制属于自己的配置文件），可以使用这些扩展定义，并配合**电视壳子**使用，以获取更好的使用体验（如，避免收藏与历史记录中出现大量无意义的海报）。这些语法扩展多用于网盘搜索类、原数据无人维护的源。
...
#### 入门玩家
1. 百度或Github 搜索配置文件，复制URL地址，关键词：TVBox配置（最好先在电脑上试一下配置文件是否能正常下载，[这里](./source.txt)是一些源，请自行确认其版权的合法性）。
